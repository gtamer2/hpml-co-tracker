...
CHECKPOINT_S4_W8 = os.path.join(CHECKPOINTS_DIR, "cotracker_stride_4_wind_8.pth")
CHECKPOINT_S4_W12 = os.path.join(CHECKPOINTS_DIR, "cotracker_stride_4_wind_12.pth") 
CHECKPOINT_S8_W16 = os.path.join(CHECKPOINTS_DIR, "cotracker_stride_8_wind_16.pth")
